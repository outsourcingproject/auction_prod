...
var ValidateAuthority = function (_think$middleware$bas) {
  (0, _inherits3.default)(ValidateAuthority, _think$middleware$bas);

  function ValidateAuthority() {
    (0, _classCallCheck3.default)(this, ValidateAuthority);
    return (0, _possibleConstructorReturn3.default)(this, _think$middleware$bas.apply(this, arguments));
  }

  ValidateAuthority.prototype.init = function init() {
    var _think$middleware$bas2;
  ...
  ValidateAuthority.prototype.run = function () {
    var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
      var pathname, user, authorities;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              user = _context.sent;
              _context.next = 6;
              return this.http.session('authorities');
            ...
            case 6:
              ...
              _context.next = 11;
              return this.userModel.getUserAuthorities(user.username);
            ...
            case 14:
              _context.next = 16;
              return this.roleModel.getRoleAuthorities('anonymous');
            ...
            case 17:
              _context.next = 19;
              return this.http.session('authorities', authorities);
            ...
            case 19:
              ...
              _context.next = 22;
              return this.http.fail('NO_AUTHORITY');
...
exports.default = ValidateAuthority;
//# sourceMappingURL=validate_authority.js.map